	      ...
	      <div class="container">
	      	<form name="frm1" id="frm1" action="${path1 }/member/insert.do" method="post" onsubmit="return joinCheck(this)">
			      <table id="tb">
			      	<tbody>
			      		<tr>
			      			<th style="background-color:#dcdcdc; text-align:center;">아이디</th>
			      			<td>
			      				<input type="text" name="id" id="id" placeholder="아이디 입력" pattern="^[a-z0-9]{5,12}" maxlength="12" required style="width:200px; float:left;">
			      		...
			      		<tr>
			      			<th style="background-color:#dcdcdc; text-align:center;" >비밀번호</th>
			      			<td>
			      		...
			      		<tr>
			      			<th style="background-color:#dcdcdc; text-align:center;">비밀번호 확인</th>
			      			<td>
			      		...
			      		<tr>
			      			<th style="background-color:#dcdcdc; text-align:center;">이름</th>
			      			<td>
			      				<input type="text" name="name" id="name" placeholder="이름 입력" maxlength="40" required>
			      			</td>
			      		</tr>
			      		<tr>
			      			<th style="background-color:#dcdcdc; text-align:center;">생년월일</th>
			      			<td>
			      				<input type="date" name="birth" id="birth" placeholder="생년월일 입력" required>
			      			</td>
			      		</tr>
			      		<tr>
			      			<th style="background-color:#dcdcdc; text-align:center;">이메일</th>
			      			<td>
			      				<input type="email" name="email" id="email" placeholder="이메일 입력" pattern="^\w+((\.\w+)?)+@\w+.?\w+\.\w+$" maxlength="80" required>
			      			</td>
			      		</tr>
			      		<tr>
			      			<th style="background-color:#dcdcdc; text-align:center;">전화번호</th>
			      			<td>
			      				<input type="tel" name="tel" id="tel" placeholder="전화번호 입력" pattern="[0-9]{2,3}-[0-9]{3,4}-[0-9]{3,4}" maxlength="19" required>
			      			</td>
			      		</tr>
		      			<tr>
			      			<th style="background-color:#dcdcdc; text-align:center;">주소</th>
			      			<td>
			      				<input type="text" name="addr1" id="addr1" placeholder="기본주소 입력" maxlength="160" required><br><br>
